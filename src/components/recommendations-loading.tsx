  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center px-4 bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
      <div className="text-center max-w-3xl">
        ...
        <div className="mb-20">
          <h1 className="text-[12rem] md:text-[16rem] font-light text-slate-900 dark:text-white animate-pulse">
        ...
        <div className="mb-12 h-20">
          <p
            key={currentStep}
            className="text-4xl md:text-5xl font-light text-slate-700 dark:text-slate-300 animate-in fade-in duration-700"
          >
            {steps[currentStep]}
          </p>
        </div>
